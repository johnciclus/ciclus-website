                      ...
                      tabContent: (
                        <GridContainer justify="left">
                          <GridItem xs={12} sm={12} md={4}>
                            ...
                            <p><b>Projects: </b>EcoGranja, Evoluci&oacute;n Web, SustenAgro, Speedy, Watson IT Help, Cortex Recommender, Brain Consortium</p>
                            <p><b>Years of experience: </b>10</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                            <p><b>Research</b></p>
                            <p><b>Projects: </b>EcoGranja, Evoluci&oacute;n Web, SustenAgro, Brain Consortium</p>
                            <p><b>Years of experience: </b>5</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                            <p><b>Web Services</b></p>
                            <p><b>Projects: </b>Evoluci&oacute;n Web, SustenAgro, Speedy, Cortex Recommender, Brain Consortium</p>
                            <p><b>Years of experience: </b>5</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                          ...
                          <GridItem xs={12} sm={12} md={4}>
                            ...
                            <p><b>Projects: </b>SustenAgro, Watson IT Help, Cortex Recommender</p>
                            <p><b>Years of experience: </b>4</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                            <p><b>Linux</b></p>
                            <p><b>Projects: </b>SustenAgro, Speedy, Watson IT Help, Cortex Recommender, Brain Consortium</p>
                            <p><b>Years of experience: </b>4</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                            <p><b>NodeJS</b></p>
                            <p><b>Projects: </b>Speedy, Watson IT Help, Cortex Recommender, Brain Consortium</p>
                            <p><b>Years of experience: </b>4</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
                          ...
                          <GridItem xs={12} sm={12} md={4}>
                            ...
                            <p><b>Projects: </b>SustenAgro, Cortex Recommender, Brain Consortium</p>
                            <p><b>Years of experience: </b>3</p>
                            <br/>
                          </GridItem>
                          <GridItem xs={12} sm={12} md={4}>
